class FinishsController < ApplicationController
  ...
  def index
    @finishs = Finish.page(params[:page]).per(100).order(sort_column + " " + sort_direction)#並べ替えのメソッドの定義
  end
