...
def create
  ...
  @product = Picture.create(pictures_params)
...
def update
  ...
  def pictures_params
    params.require(:product).permit(:photo).merge(product_id: @product.id)
  end
  def pictures_params2
    params.require(:product).permit(:photo).merge(product_id: params[:product_id])
  end


  def finish_params
    params.require(:product).permit(:member_id)
  end
